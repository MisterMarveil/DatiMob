  ...
  function KeypadClassConstructor (Framework7Class) {
    return /*@__PURE__*/(function (Framework7Class) {
      ...
      Keypad.prototype.renderToolbar = function renderToolbar () {
        ...
        var toolbarHtml = "\n        <div class=\"toolbar\">\n          <div class=\"toolbar-inner\">\n            <div class=\"left\"></div>\n            <div class=\"right\">\n              <a href=\"#\" class=\"link sheet-close0 popover-close0\">78" + (keypad.params.toolbarCloseText) + "</a>\n            </div>\n          </div>\n        </div>\n      ";
...
function iniPassword_keypad(){
	var numpad = app.keypad.create({
		...
		buttons: [
			...
			{
				html:"<span class='key cancel' style='font-size:15px;'>FORGET?</span>",
				value: 10,
				onClick: function () {
					console.log('Button forget clicked');
				}
			},
			{
				html:"<span class='key'>0</span>",
				value: 0,
				onClick: function () {
					key(0);
				}
			...
			{
				html:"<span class='key'><i class='fas fa-backspace'></i></span>",
				value: 11,
                cssClass: 'keypad-delete-button',
				onClick: function () {
					key(11);
...
function iniCall_keypad(){
	var numpad = app.keypad.create({
		...
		buttons: [
			{
				html:"<span class='key'>1</span><span class='keypad-button-letters'></span>",
				value: 1,
                cssClass: 'call_button',
				onClick: function () {
					key(1);
				}
			},
			{
				html:"<span class='key'>2</span><span class='keypad-button-letters'>ABC</span>",
				value: 2,
                cssClass: 'call_button',
				onClick: function () {
					key(2);
			...
			{
				html:"<span class='key'>3</span><span class='keypad-button-letters'>DEF</span>",
				value: 3,
                cssClass: 'call_button',
				onClick: function () {
					key(3);
			...
			{
				html:"<span class='key'>4</span><span class='keypad-button-letters'>GHI</span>",
				value: 4,
                cssClass: 'call_button',
				onClick: function () {
					key(4);
			...
			{
				html:"<span class='key'>5</span><span class='keypad-button-letters'>JKL</span>",
				value: 5,
                cssClass: 'call_button',
				onClick: function () {
					key(5);
			...
			{
				html:"<span class='key'>6</span><span class='keypad-button-letters'>MNO</span>",
				value: 6,
                cssClass: 'call_button',
				onClick: function () {
					key(6);
			...
			{
				html:"<span class='key'>7</span><span class='keypad-button-letters'>PQRS</span>",
				value: 7,
                cssClass: 'call_button',
				onClick: function () {
					key(7);
			...
			{
				html:"<span class='key'>8</span><span class='keypad-button-letters'>TUV</span>",
				value: 8,
                cssClass: 'call_button',
				onClick: function () {
					key(8);
			...
			{
				html:"<span class='key'>9</span><span class='keypad-button-letters'>WXYZ</span>",
				value: 9,
                cssClass: 'call_button',
				onClick: function () {
					key(9);
			...
			{
				html:"<span class='key ' style='font-size:15px;'>*</span>",
				value: "*",
                cssClass: 'call_button',
				onClick: function () {
					key('*');
			...
			{
				html:"<span class='key'><i class='fas fa-address-card'></i></span>",
				value: "cnot",
                cssClass: 'dia_button',
				onClick: function () {
					key('contact');
			...
			{
				html:"<span class='key'><i style='color:#fff;' class='fas fa-phone'</i></span>",
				value: "call",
                cssClass: 'dia_button dial',
				onClick: function () {
					key('call');
				}
			},
