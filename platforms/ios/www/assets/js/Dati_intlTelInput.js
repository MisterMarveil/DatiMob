        ...
        function() {
            ...
            _createClass(Iti, [ {
                ...
                value: function _searchForCountry(query) {
                    for (var i = 0; i < this.countries.length; i++) {
                        //if (this._startsWith(this.countries[i].name, query)) {    //DATI Hack
                        var reg = new RegExp('^'+query, 'i');
                        if(reg.test(this.countries[i].name) || query == this.countries[i].dialCode || query == this.countries[i].iso2){
